...
<div data-role="page" >
    ...
    <?php if(is_array($allSecretList)): $k = 0; $__LIST__ = $allSecretList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?><section class="news">
            <div class="newTop">
